...
function buttonClick(question_number, choice_number,clicked_choice, true_choice) {
    document.getElementById(clicked_choice).classList.add("failed");
    console.log(true_choice)
        if (clicked_choice == true_choice) {
            var true_choice = document.getElementById(true_choice);
